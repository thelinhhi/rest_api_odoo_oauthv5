...
class OdooValidator(RequestValidator):
    ...
    https://github.com/oauthlib/oauthlib/blob/master/oauthlib/oauth2/rfc6749/request_validator.py#L77
    """
    def _load_client(self, request, client_id=None):
        """ Returns a client instance for the request """
        client = request.client
        if not client:
            request.client = http.request.env['oauth2.client.model'].search([
                ('client_id', '=', client_id or request.client_id),
            ])
    ...
    def save_bearer_token(self, token, request, *args, **kwargs):
        ...
        return "http://localhost:8069/"
        raise NotImplementedError(' save_bearer_token Subclasses must implement this method.')
    ...
    def validate_redirect_uri(self, client_id, redirect_uri, request, *args, **kwargs):
        ...
        # raise NotImplementedError('validate_redirect_uri Subclasses must implement this method.')
